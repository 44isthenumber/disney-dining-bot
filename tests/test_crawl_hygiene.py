...
class CrawlHygieneTest(unittest.TestCase):
    ...
    def test_sitemap_uses_pretty_public_urls(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "https://magictablefinder.com/blog/disney-dining-week-out-recovery",
                "https://magictablefinder.com/blog/cinderellas-royal-table-wrong-date-party-of-5",
    ...
    def test_netlify_has_no_homepage_soft_404_splat(self):
        ...
        self.assertIn('from = "/blog/disney-dining-week-out-recovery"', NETLIFY)
        self.assertIn('from = "/blog/cinderellas-royal-table-wrong-date-party-of-5"', NETLIFY)
        ...
        self.assertIn('to = "/blog/disney-dining-week-out-recovery.html"', NETLIFY)
        self.assertIn('to = "/blog/cinderellas-royal-table-wrong-date-party-of-5.html"', NETLIFY)
